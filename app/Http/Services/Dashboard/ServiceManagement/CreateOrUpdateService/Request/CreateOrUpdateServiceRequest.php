<?php
namespace App\Http\Services\Dashboard\ServiceManagement\CreateOrUpdateService\Request;
...
class CreateOrUpdateServiceRequest extends BaseRequest
{
    /**
    ...
    public function rules(): array
    {
        return [
            ...
            'description' => 'nullable|string|max:500|regex:/^[\p{Arabic}\s]+$/u',
