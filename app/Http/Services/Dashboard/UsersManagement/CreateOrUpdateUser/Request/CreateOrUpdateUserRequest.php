<?php
namespace App\Http\Services\Dashboard\UsersManagement\CreateOrUpdateUser\Request;
use Illuminate\Contracts\Validation\Validator;
use Illuminate\Validation\ValidationException;
use App\Http\Core\Request\BaseRequest;

class CreateOrUpdateUserRequest extends BaseRequest
{
    /**
    ...
    public function rules(): array
    {
        ...
        return [
            'firstName'=>'required',
            'lastName'=>'required',
            'phoneNumber'=>'required|min:10|unique:users,phoneNumber,'.$id,
            'password' => [
