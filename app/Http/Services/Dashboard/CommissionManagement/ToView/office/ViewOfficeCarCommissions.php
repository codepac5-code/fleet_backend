...
class ViewOfficeCarCommissions extends Controller
{
    public function __invoke (Request $request)
    {
        ...
        return view('commission.office_commissions.driver_owner_commissions', compact('commissions','pageTitle','auth_user'));
    }
}
