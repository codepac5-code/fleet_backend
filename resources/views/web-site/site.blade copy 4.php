...
.cards-wrapper{
  ...
  background: linear-gradient(
    180deg,
    rgba(49, 40, 115, 0.062),
    rgba(242, 157, 11, 0.121)
  );
...
.incubator-logo {
    display: inline-block;
    padding: 4px; /* المسافة بين الصورة والحدود */
    border-radius: 12px;
...
<a href="/" onclick="showPage('home')" class="logo">
  <div class="logo-icon motion-clear">

    <svg viewBox="0 0 64 64" fill="none">

      <path d="M8 42 Q32 12 56 28"
        stroke="currentColor"
        stroke-width="5"
      ...
      <circle cx="8" cy="42" r="5" fill="currentColor" class="dot"/>
  ...
  <span class="logo-text">
    <span class="main">Fleet</span><span class="accent">OS</span>
  </span>
</a>
    ...
    <div class="max-w-5xl mx-auto">
      ...
      <div class="flex items-end justify-between gap-6 flex-wrap mb-12">
        <div>
          ...
          <h3 class="text-3xl font-extrabold text-[#312873]">
            From application to marketplace growth
          </h3>
        </div>

        <!-- ⚠️ نفس الأزرار بدون أي تعديل -->
      ...
      <div class="grid md:grid-cols-5 gap-6 steps-grid">
        ...
        <div class="glass-card step-card">
          ...
          <p class="step-title">Apply & Verify</p>
          <p class="step-desc">Market status + office readiness checks.</p>
        </div>
        ...
        <div class="glass-card step-card">
          ...
          <p class="step-title">Launch Office</p>
          <p class="step-desc">Listing, zones, pricing ranges, policies.</p>
        </div>
        ...
        <div class="glass-card step-card">
          ...
          <p class="step-title">Onboard Drivers</p>
          <p class="step-desc">Drivers join via FleetOS Driver App.</p>
        </div>
        ...
        <div class="glass-card step-card">
          ...
          <p class="step-title">Go Live</p>
          <p class="step-desc">Riders discover and choose your brand.</p>
        </div>
        ...
        <div class="glass-card step-card">
          ...
          <p class="step-title">Grow</p>
          <p class="step-desc">Improve ratings, conversion, reliability.</p>
        </div>
