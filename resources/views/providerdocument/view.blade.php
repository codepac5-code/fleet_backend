                ...
                <div class="card card-block card-stretch">
                    <div class="card-body p-0">
                        <div class="d-flex justify-content-between align-items-center p-3 flex-wrap gap-3">
                            <h5 class="font-weight-bold">{{ __('messages.Office_Document_List') }}</h5>
                            @if($auth_user->can('providerdocument add'))
                            <a href="{{ route('providerdocument.create',['providerdocument' => $providerdata->id]) }}" class="float-right mr-1 btn btn-sm btn-primary"><i class="fa fa-plus-circle"></i> {{ trans('messages.add_form_title',['form' => trans('messages.Officedocument')  ]) }}</a>
                            @endif
                        </div>
