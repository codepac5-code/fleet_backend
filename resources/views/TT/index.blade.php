...
<body>
  ...
  <a class="carousel-control-next" href="#main_slider" role="button" data-slide="next">
        ...
        <div class="taxis_section_2">
          ...
          <div class="carousel-wrapper">
            <div class="carousel-track">
              ...
              <!-- كارد 1 -->
              <div class="taxi_main" style="width: 250px; flex-shrink: 0; border-radius: 40px;" >
                <div class="round_1">01</div>
                <h2 class="carol_text">CAR 1</h2>
                <p class="reader_text">act that a reader will be<br> distracted </p>
                <div class="images_2"><a href="#"><img src="images/img-2.png" alt="Car 1"></a></div>
              </div>
    
              <!-- كارد 2 -->
              <div class="taxi_main" style="width: 250px; flex-shrink: 0;">
                <div class="round_1">02</div>
                <h2 class="carol_text">CAR 2</h2>
                <p class="reader_text">act that a reader will be<br> distracted </p>
                <div class="images_2"><img src="images/img-2.png" alt="Car 2"></div>
              </div>
              ...
              <div class="taxi_main" style="width: 250px; flex-shrink: 0;">
                ...
                <p class="reader_text">act that a reader will be<br> distracted </p>
                <div class="images_2"><img src="images/img-2.png" alt="Car 3"></div>
              </div>
    
              <!-- كارد إضافي -->
              <div class="taxi_main" style="width: 250px; flex-shrink: 0;">
                <div class="round_1">04</div>
                <h2 class="carol_text">CAR 4</h2>
                <p class="reader_text">act that a reader will be<br> distracted </p>
                <div class="images_2"><img src="images/img-2.png" alt="Car 4"></div>
              </div>
    ...
    <div id="booking" class="ride_section layout_padding">
      <div class="container">
        <div class="ride_main">
          <h1 class="ride_text">Why Ride <span style="color: #f4db31;">With Fleet?</span></h1>
      </div>
        </div>
    </div>
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-sm-8">
            ...
            <div class="book_bt"><a href="#">Try NOW</a></div>
          </div>
        </div>
      </div>
      <div class="container">
        <div class="row">
          <div class="col-sm-8">
            ...
            <div class="book_bt_2"><a href="#">Try NOW</a></div>
          </div>
          <div class="col-sm-4">
