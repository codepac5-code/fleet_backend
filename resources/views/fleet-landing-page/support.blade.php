        ...
        <div class="container1">
          <div class="about-content mt-50 wow fadeInLeftBig" data-wow-duration="0.5s" data-wow-delay="0.2s">
            <div class="section-title text-center">
              ...
              <h3 class="title">نموذج الدعم الفني</h3>
            </div>
      
            <p style="text-align: center;">يرجى تعبئة النموذج أدناه لطلب المساعدة أو التواصل مع فريق الدعم.</p>
      
            <form onsubmit="handleSupport(event)" method="post" enctype="text/plain">
              ...
              <input type="tel" id="mobile" name="رقم الهاتف" placeholder="مثال: 0501234567" required
                pattern="^(\+971|0)?5\d{8}$">
      
              <label for="subject">نوع المشكلة:</label>
              <select id="subject" name="نوع المشكلة" required>
                <option value="">اختر نوع المشكلة</option>
                <option value="تطبيق لا يعمل">التطبيق لا يعمل</option>
                <option value="مشكلة بالحساب">مشكلة في الحساب</option>
                <option value="مشاكل دفع">مشكلة في الدفع</option>
                <option value="اقتراح أو استفسار">اقتراح أو استفسار</option>
              </select>
      
              <label for="message">وصف المشكلة:</label>
              <textarea id="message" name="الوصف" rows="4" required></textarea>
      
              <div class="checkbox-row">
                <input type="checkbox" id="agree" required>
                <label for="agree">أوافق على مشاركة بياناتي مع فريق الدعم لغرض المساعدة.</label>
              </div>
