              ...
              .fleet
                ...
                >
                  <ul id="nav" class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item">
                      <a class="page-scroll" href="#about1">
                        {{-- About --}}
                      حول التطبيق
                      </a>
                    </li>
          ...
          <div class="col-lg-6 order-lg-last">
            ...
            >
              ...
              <p class="text" >
                ...
                يمكنكم ربط أسطولكم بسائقين تابعين، وإدارة الطلبات والمدفوعات بكفاءة. 
          ...
          <div class="container">
            ...
            <div class="taxis_section_2">
              {{-- <div class="carousel-wrapper">
                ...
                {{-- 
                <div id="servicesText" class="services-text">خدماتنا</div>
              </div>
            </div> --}}
        ...
        <div class="swiper-slide">
          <div class="testimonial-item">
            ...
            <p>
              ...
              <span>Proin iaculis purus consequat sem cure digni ssim...</span>
...
<section class="faq section" style="margin-top: 100px;">
  <div class="container">
      <div class="row"  tyle="margin-top: 50px;">
          <div class="col-12">
              <div class="section-title">
                ...
                <h3 class="wow zoomIn" data-wow-delay=".2s">.........</h3> --}}
                  ...
                  <h3 class="wow zoomIn" data-wow-delay=".2s" style="margin-top: 100px">الأسئلة الشائعة</h3>
            ...
            <div class="col-lg-12">
              <div class="copyright d-sm-flex justify-content-between">
                <div class="copyright-content">
                  <p class="text">
                    Designed and Developed by codeP - 2025
