  ...
  <head>
    ...
    <div class="card">
        ...
        <div class="row justify-content-between">
            <div>
              <div class="col-md-12">
                  <form action="{{ route('sub-service.bulk-action') }}" id="quick-action-form" class="form-disabled d-flex gap-3 align-items-center">
                    @csrf
    ...
    <script>
        ...
        window.renderedDataTable = $('#datatable').DataTable({
                ...
                ajax: {
                  "type"   : "GET",
                  "url"    : '{{ route("sub-service.index-data") }}',
                  "data"   : function( d ) {
                    d.search = {
                      value: $('.dt-search').val()
                    };
