<form method="POST" action="{{ route('themesetup') }}" enctype="multipart/form-data" data-toggle="validator">
    @csrf
    <input type="hidden" name="id" value="{{ null }}" placeholder="id" class="form-control">
    <input type="hidden" name="page" value="{{ $page }}" placeholder="id" class="form-control">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-8 mt-sm-0 mt-2">
                            <div class="custom-file col-md-12">
                                <input type="file" name="logo" class="custom-file-input custom-file-input-sm detail" id="logo" lang="en" accept="image/*" onchange="preview()">
                                {{-- @if($themesetup && getMediaFileExit($themesetup, 'logo')) --}}
            ...
            <div class="form-group">
                ...
                <div class="col-sm-12">
                    <div class="row">
                        ...
                        <div class="col-sm-8 mt-sm-0 mt-2">
                            <div class="custom-file col-md-12">
                                <input type="file" name="favicon" class="custom-file-input custom-file-input-sm detail" id="favicon" lang="en" accept="image/*" onchange="preview()">
                                {{-- @if($themesetup && getMediaFileExit($themesetup, 'favicon')) --}}
        ...
        <div class="col-lg-6">
            <div class="form-group">
                ...
                <div class="col-sm-12">
                    <div class="row">
                        ...
                        <div class="col-sm-8 mt-sm-0 mt-2">
                            <div class="custom-file col-md-12">
                                <input type="file" name="footer_logo" class="custom-file-input custom-file-input-sm detail" id="footer_logo" lang="en" accept="image/*" onchange="preview()">
                                {{-- @if($themesetup && getMediaFileExit($themesetup, 'footer_logo')) --}}
                                    <label class="custom-file-label upload-label">{{ getDashboardLogo() }}</label>
                                {{-- @else
                                    <label class="custom-file-label upload-label">{{ 'logo.png' }}</label>
                                @endif --}}
                            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-12">
                    <div class="row">
                        <div class="col-sm-4">
                            <img src="{{ getLoader() }}" style="height: 80px; width: auto;" id="loader_preview" alt="loader" class="image loader loader_preview">
                        ...
                        <div class="col-sm-8 mt-sm-0 mt-2">
                            <div class="custom-file col-md-12">
                                <input type="file" name="loader" class="custom-file-input custom-file-input-sm detail" id="loader" lang="en" accept="image/*" onchange="preview()">
                                {{-- @if($themesetup && getMediaFileExit($themesetup, 'loader')) --}}
                                    <label class="custom-file-label upload-label">{{ getLoader() }}</label>
                                {{-- @else
        ...
        <div class="col-lg-12">
            <div class="form-group">
                <div class="col-md-offset-3 col-sm-12">
                    <button type="submit" class="btn btn-md btn-primary float-md-right">{{ __('messages.save') }}</button>
                </div>
            </div>
        </div>
    </div>
