<x-master-layout>
    <div class="container-fluid">
        <div class="row justify-content-center">
            ...
            <!-- فورم البحث عن المستخدم أو السائق -->
            <div class="col-lg-6">
                <div class="card">
                    <div class="card-body">
            ...
            <div class="col-lg-4 mt-4" id="earningsCard" style="display: none;">
                <div class="card text-white bg-primary">
                    <div class="card-body text-center">
                        ...
                        <h5>{{ __('messages.total_earnings') }}</h5>
    ...
    fetch(`{{ route('wallet.getUserInfo') }}?userType=${userType}&phoneNumber=${phoneNumber}`)
        ...
        .then(data => {
            if (data.success) {
                ...
                // 🔹 تحديث `DataTable` وتمرير البيانات الديناميكية
...
<script src="https://cdn.jsdelivr.net/npm/sweetalert2@10"></script>
    <!-- ستايل مخصص لجعل الواجهة أكثر جاذبية -->
    <style>
