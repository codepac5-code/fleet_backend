            ...
            <div class="card card-block card-stretch">
                <div class="card-body p-0">
                    <div class="d-flex justify-content-between align-items-center p-3 flex-wrap gap-3">
                        ...
                        <a href="{{ route('commissions.fleet') }}" class="float-right btn btn-sm btn-primary">
        ...
        <div class="row justify-content-center">
            <div class="col-lg-6">
                <div class="custom-commission-container p-4 shadow rounded">
                    ...
                    {{-- <div class="form-group mt-3 text-center" style="width: 25%; "> 

                    @error('completed_value')
                        <small class="text-danger">{{ $message }}</small>
                    @enderror
                </div> --}}

                    <form action="{{ route('commissions.fleet.update') }}" method="POST" class="mt-3">
                        @csrf
                        @method('POST')
                        <input type="hidden" name="type" value="fleet_driver">
                        ...
                        <div class="custom-commission-input-group mb-3 d-flex align-items-center">
                            ...
                            <input type="number" name="fleet_driver" class="form-control" id="office" 
                                value="{{ $fleet->fleet_commission_value_with_driver ?? 0 }}" min="0" max="100">
                        ...
                        <!-- Driver Commission -->
                        <div class="custom-commission-input-group mb-3 d-flex align-items-center">
                            <i class="fas fa-car fa-lg me-2 text-warning"></i>
                            <input type="number" name="driver_commission" class="form-control" id="driver" 
                                value="{{ $fleet->driver_commission_value ?? 0 }}" min="0" max="100">
                            <span class="ms-2">%</span>
                        </div>
