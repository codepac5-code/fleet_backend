               ...
               <ul class="list-inline m-0">
                  ...
                  <li class="mb-2">
                     <span class="d-flex gap-3">
                        ...
                        <span class="d-inline-block w-75">{{($data->office)->officeName}}</span>
                     </span>
                  </li>
                  <li>
                     <span class="d-flex gap-3">
               ...
               <ul class="list-inline m-0">
                  <li class="mb-2">
                     <span class="d-flex gap-3">
                        ...
                        <span class="d-inline-block w-75">{{getPriceFormat($data->totalAmount)}}</span>
                     </span>
                  </li>
                  <li class="mb-2">
                     <span class="d-flex gap-3">
                        <span class="d-inline-block w-25 fw-bold">{{__('messages.method')}}:</span>
                        <span class="d-inline-block w-75 text-capitalize">{{ optional($data->payment)->name ?? '-' }}</span>
                     </span>
                  </li>
                  <li>
                     <span class="d-flex gap-3">
                        ...
                        @if(!empty($data->payment))
                           <span class="d-inline-block w-75 status-text text-success text-capitalize">{{ str_replace("_"," ",optional($data->paymentStatus)) ?? '-' }}</span>
                        @else
