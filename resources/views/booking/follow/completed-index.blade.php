...
<script>
    ...
    window.renderedDataTable3 = $('#datatable').DataTable({
    processing: true,
    serverSide: true,
    autoWidth: false,
    responsive: true,
    ...
    ajax: {
        type: "GET",
        url: `/booking/booking-index-data?type=completed&officeId=${officeId}`, 
        data: function(d) {
                    d.search = {
                      value: $('.dt-search').val()
                    };
                ...
                columns: [
                    ...
                    // },
                    {
                        data: 'details',
                        name: 'details',
                        title: "{{__('messages.orderDetails')}}"
                    },
                    {
                        data: 'status',
                        name: 'status',
  ...
  socket.on('admins:new-order-completed', (data) => {
