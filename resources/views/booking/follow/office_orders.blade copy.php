                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <ul class="nav nav-tabs nav-fill custom-tabs-nav" id="customTabs">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link custom-tabs-link custom-tabs-hover" data-tab="ongoing">
                                    ...
                                    <div class="card-body">
                                        <div class="tab-content">
                                            ...
                                            <div class="tab-pane" id="ongoing">
                                                <h4 class="custom-tabs-title">
                                                    <i class="fa-solid fa-truck-fast animated-icon rotate-animation ongoing-icon"></i> 
                                                    ⏳ {{ __('messages.ongoing_orders') }}
