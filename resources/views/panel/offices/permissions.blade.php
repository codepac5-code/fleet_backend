...
@section('title', textByLanguage('صلاحيات المكتب', 'Office permissions'))
@section('page-title', textByLanguage('صلاحيات المكتب', 'Office permissions'))
...
@section('content')
    ...
    <x-panel.page-toolbar
        ...
        :subtitle="textByLanguage('تحديد ما يمكن لهذا المكتب الوصول إليه', 'Control what this office can access')">
        <x-slot:actions>
    ...
    <form method="POST" action="{{ route('panel.admin.office.permissions.update', $office->id) }}" id="permForm">
        ...
        <div class="p-grid p-grid--2" style="align-items: stretch;">
            @foreach($groups as $group)
                @php $groupPerms = collect($group['permissions']); @endphp
