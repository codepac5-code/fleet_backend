...
if( auth()->user()->hasAnyRole(['super-admin']) ){ 
    ...
    $menu->add(__('messages.sidebar_form_title',['form' => trans('messages.service')]), ['class' => 'category-main yellow-bg'])
    ->data('permission', ['category list','subcategory list','service list']);

    $menu->add('<span>'.__('messages.Service').'</span><span class="custom-tooltip"><span class="tooltip-text">'.__('messages.Service').'</span></span>', ['route' => 'service.index'])
    ->prepend('<svg class="mr-2 icon-yellow" width="15" height="15" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"> <path d="M2.5 6.5C2.5 4.29086 4.29086 2.5 6.5 2.5C8.70914 2.5 10.5 4.29086 10.5 6.5V9.16667C10.5 9.47666 10.5 9.63165 10.4659 9.75882C10.3735 10.1039 10.1039 10.3735 9.75882 10.4659C9.63165 10.5 9.47666 10.5 9.16667 10.5H6.5C4.29086 10.5 2.5 8.70914 2.5 6.5Z" stroke="currentColor" stroke-width="1.5"/> <path d="M13.5 14.8333C13.5 14.5233 13.5 14.3683 13.5341 14.2412C13.6265 13.8961 13.8961 13.6265 14.2412 13.5341C14.3683 13.5 14.5233 13.5 14.8333 13.5H17.5C19.7091 13.5 21.5 15.2909 21.5 17.5C21.5 19.7091 19.7091 21.5 17.5 21.5C15.2909 21.5 13.5 19.7091 13.5 17.5V14.8333Z" stroke="currentColor" stroke-width="1.5"/> <path d="M2.5 17.5C2.5 15.2909 4.29086 13.5 6.5 13.5H8.9C9.46005 13.5 9.74008 13.5 9.95399 13.609C10.1422 13.7049 10.2951 13.8578 10.391 14.046C10.5 14.2599 10.5 14.5399 10.5 15.1V17.5C10.5 19.7091 8.70914 21.5 6.5 21.5C4.29086 21.5 2.5 19.7091 2.5 17.5Z" stroke="currentColor" stroke-width="1.5"/> <path d="M13.5 6.5C13.5 4.29086 15.2909 2.5 17.5 2.5C19.7091 2.5 21.5 4.29086 21.5 6.5C21.5 8.70914 19.7091 10.5 17.5 10.5H14.6429C14.5102 10.5 14.4438 10.5 14.388 10.4937C13.9244 10.4415 13.5585 10.0756 13.5063 9.61196C13.5 9.55616 13.5 9.48982 13.5 9.35714V6.5Z" stroke="currentColor" stroke-width="1.5"/> </svg>')
    ->link->attr(['class' => '']);

    $menu->add('<span>'.__('messages.Subservice').'</span><span class="custom-tooltip"><span class="tooltip-text">'.__('messages.Subservice').'</span></span>', ['route' => 'sub-service.index'])
...
// $menu->add('<span>'.__('messages.Offices').'</span><span class="custom-tooltip"><span class="tooltip-text">'.__('messages.Offices').'</span></span>')
// ->prepend('<svg class="mr-2" width="15" height="15" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
...
->link->attr(['class' => '']);
    ...
    $menu->add(__('messages.sidebar_form_title',['form' => trans('messages.drivers')]), ['class' => 'category-main']);//->data('permission', ['provider list','handyman list','user list']);
...
$menu->add('<span>'.__('Commission').'</span><span class="custom-tooltip"><span class="tooltip-text">'.__('messages.booking').'</span></span>', ['route' => 'commissions.fleet'])
 ...
 --}}
    ...
    <div class="data-scrollbar" data-scroll="1">
        <div class="user-profile">
            <div class="avatar">
            <img class="avatar-50 rounded-circle bg-light" alt="user-icon" src="{{ auth()->user()->photo ?? get_default_image($type = 'user') }}">
            </div>
            @if(auth()->user()->hasAnyRole('super-admin'))
            <div class="user-info">
