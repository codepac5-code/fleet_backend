    ...
    <div class="modal-content">
        ...
        <form action="{{ route('role.save') }}" method="POST" data-toggle="validator">
                    ...
                    <div class="row">
                        <div class="col-md-12 form-group">
                            <label for="parent_id" class="form-control-label">
                                {{ trans('messages.parent_permission') }}
                            </label>
                            <select name="parent_id" id="parent_id" class="select2js form-control"
                                data-ajax--url="{{ route('ajax-list', ['type' => 'permission']) }}"
            ...
            <div class="modal-footer">
                ...
                <button type="submit" class="btn btn-md btn-primary" id="btn_submit" data-form="ajax">
                    {{ trans('messages.save') }}
                </button>
            </div>
        </form>
