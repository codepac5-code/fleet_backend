<x-master-layout>
                            ...
                            <div class="form-group col-md-4">
                                ...
                                {{ Form::select('provider_address_id[]', [], old('provider_address_id'), [
                                 ...
                                 @if(auth()->user()->hasAnyRole(['provider']))
                                    <a href="{{ route('provideraddress.create', ['provideraddress' => auth()->id()]) }}" id="add_office_address_link" class=""><i class="fa fa-plus-circle mt-2"></i>
                                 {{ trans('messages.add_form_title',['form' => trans('messages.provider_address')  ]) }}</a>
                                 @else
                                    <a href="#" id="add_office_address_link" class=""><i class="fa fa-plus-circle mt-2"></i>
                                 {{ trans('messages.add_form_title',['form' => trans('messages.provider_address')  ]) }}</a>
                                 @endif
                            </div> 
    ...
    var discountError = document.getElementById('discount-error');
      ...
      document.addEventListener('DOMContentLoaded', function () {
        ...
        document.getElementById('add_office_address_link').addEventListener('click', function (event) {
    ...
    function selectprovider(selectElement){
        ...
        var addProviderAddressLink =  document.getElementById('add_office_address_link');
