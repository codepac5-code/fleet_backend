            ...
            <div class="col-lg-12">
                <div class="card card-block card-stretch">
                    <div class="card-body p-0">
                        <div class="d-flex justify-content-between align-items-center p-3 flex-wrap gap-1">
                            <h3 class="font-weight-bold">قائمة التذاكر</h3>
                            <div class="row  gap-2" style="padding-right: 5px;">
...
<section class="filters" aria-label="شريط البحث والفلاتر">
  ...
  <select id="agentFilter" aria-label="فلتر الموظف المعالج">
    ...
    <option value="agent1">بسام نكز </option>
    <option value="agent2">محمد الوغا </option>
    <option value="agent3">مصعب السيوفي </option>
  </select>
...
<script>
  const ticketsData = [
    ...
    },
    {
      ...
      department: 'finance',
      agent: 'agent2',
      agentName: ' احمد العبدالله',
      agentImg: 'storage-r/user/profile/1730798867_.jpg',
      priority: 'medium',
