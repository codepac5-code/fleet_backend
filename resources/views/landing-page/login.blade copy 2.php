...
@endif
  ...
  <div class="country-inside" onclick="toggleCountries()">
    <img id="selectedFlag" src="/flags/sy.svg" class="mini-flag">
    <i class="fa-solid fa-chevron-down"></i>
  </div>

  <input type="email" name="email" placeholder="البريد الإلكتروني" required>

  <input type="hidden" name="region" id="regionInput" value="sy">

  <div class="country-list" id="countryList">
    <div onclick="selectCountry('sy')" class="country-item">
      <img src="https://t4.ftcdn.net/jpg/11/36/33/79/360_F_1136337946_c5gr8LMbgzdkl80hVpy8xRXYYQBTlp5x.jpg" class="mini-flag"> Syria
    </div>
    <div onclick="selectCountry('us')" class="country-item">
      <img src="https://flagfactoryshop.com/image/cache/catalog/products/flags/national/mockups/usa-1200x720.jpg" class="mini-flag"> United States
    </div>
    <div onclick="selectCountry('qa')" class="country-item">
      <img src="https://i0.wp.com/flag-shop.ca/wp-content/uploads/2024/11/img-flag-shop-flags-of-the-world-qatar-flag-3-5.webp?fit=1080%2C648&ssl=1" class="mini-flag"> Qatar
    </div>
  </div>
</div>
...
function selectCountry(code) {
  document.getElementById("selectedFlag").src = "https://flagfactoryshop.com/image/cache/catalog/products/flags/national/mockups/usa-1200x720.jpg";
  document.getElementById("regionInput").value = code;
