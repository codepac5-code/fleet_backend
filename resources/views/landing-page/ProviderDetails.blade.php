      ...
      <div class="row">
         ...
         <div class="col-lg-8 mt-lg-0 mt-5">
            ...
            @if(!empty($providerData['service']))
               ...
               <service-list-section :user_id="{{json_encode($auth_user_id)}}" :service="{{ json_encode($providerData['service']) }}" :is_office_detail={{true}} :max_records="6" :favourite="{{json_encode($favourite)}}" ></service-list-section>
            @endif
