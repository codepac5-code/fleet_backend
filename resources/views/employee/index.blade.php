  ...
  <head>
      ...
      <div class="card">
          ...
          <div class="row justify-content-between">
              <div>
                  <div class="col-md-12">
                    <form action="{{ route('employee.bulk-action') }}" id="quick-action-form" class="form-disabled d-flex gap-3 align-items-center">
                      @csrf
                  ...
                  data--submit="{{ route('employee.bulk-action') }}"
...
document.addEventListener('DOMContentLoaded', (event) => {
    window.renderedDataTable = $('#datatable').DataTable({
        ...
        columns: [
            ...
            {
                data: 'employeeJobName',
                name: 'employeeJobName',
                title: "{{ __('messages.job_title') }}",
                searchable: true,
            },
            {
                data: 'isOnline',
                name: 'isOnline',
                title: "{{ __('messages.status_conection') }}",
                searchable: false,
            },
            {
                data: 'gender',
