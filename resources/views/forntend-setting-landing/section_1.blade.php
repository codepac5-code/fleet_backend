...
{{ Form::hidden('type', $tabpage, array('placeholder' => 'id','class' => 'form-control')) }}
        ...
        <div class="row" id='enable_section_1'>
            ...
            <div class="form-group col-md-12 d-flex justify-content-between">
                <label for="enable_popular_office">{{__('messages.enable_popular_office')}}</label>
                <div class="custom-control custom-switch">
                    <input type="checkbox" class="custom-control-input" name="enable_popular_office" id="enable_popular_office">
                    <label class="custom-control-label" for="enable_popular_office"></label>
                </div>
            </div>
            <div class="form-group col-md-8" id='enable_select_office'>
...
<script>
    ...
    ///// open select popular provider ///////////
     ...
     var enable_popular_office = $("input[name='enable_popular_office']").prop('checked');
    checkEnableProvider(enable_popular_office);

    $('#enable_popular_office').change(function() {
        value = $(this).prop('checked') == true ? true : false;
    ...
    function checkEnableProvider(value) {
        if (value == true) {
            $('#enable_select_office').removeClass('d-none');
            $('#provider_id').prop('required', true);
        } else {
            $('#enable_select_office').addClass('d-none');
    ...
    function getConfig(type) {
        ...
        $.ajax({
            ...
            success: function (response) {
                var obj = '';
                var section_1 = title = description = current_location = enable_search = enable_post_job = enable_popular_services = category_ids = enable_popular_office = provider_id = '';
                ...
                if (response) {
                    ...
                    if (obj !== null) {
                        ...
                        var enable_popular_office = obj.enable_popular_office;
                    ...
                    $('#enable_popular_office').prop('checked',enable_popular_office == 'on');
                    $('#enable_popular_office').change();
