<template>
    <!-- Tab panes -->
    <div :class="is_office_detail == true ? 'tab-content' : 'tab-content'">
        <div class="tab-pane active show" id="cleaning">
            <div class="row our-service animated fadeInUp">
                ...
                <template v-else>
                    <div v-for="data in getLimitedService(service)" :key="data" :class="is_office_detail == true ? 'col-md-6':'col-xl-4 col-sm-6'">
                        <ServiceCard
                            :user_id="user_id"
                            :service_id="data.id"
...
const props = defineProps(['service','is_office_detail','max_records','user_id','favourite']);
